...
class BukuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.buku.buku.index', compact('books', 'books_count'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.admin.buku.buku.create', [
    ...
    public function cetak()
    {
        ...
        $pdf = PDF::loadView('pages.admin.buku.buku.cetak', ['books' => $books])->setPaper('a4', 'landscape');
        return $pdf->stream();
    }
    ...
    public function cetakpenambahan()
    {
        ...
        $pdf = PDF::loadView('pages.admin.buku.buku.cetak-penambahan', [
    ...
    public function cetakdipinjam()
    {
        ...
        $pdf = PDF::loadView('pages.admin.buku.buku.cetak-dipinjam', ['classifications' => $classifications], ['summary' => $summary])->setPaper('a4', 'landscape');
    ...
    public function cetakdikembalikan()
    {
        ...
        $pdf = PDF::loadView('pages.admin.buku.buku.cetak-dikembalikan', ['classifications' => $classifications], ['summary' => $summary])->setPaper('a4', 'landscape');
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.buku.buku.edit', [
            'item' => $item,
            'publishers' => $publishers,
            'classifications' => $classifications
        ]);
