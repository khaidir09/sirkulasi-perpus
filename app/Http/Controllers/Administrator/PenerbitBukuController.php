...
class PenerbitBukuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.buku.penerbit.index', compact('publishers', 'publishers_count'));
    }
    ...
    {
        return view('pages.admin.buku.penerbit.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.buku.penerbit.edit', [
            'item' => $item
        ]);
    }
