...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Perpustakaan SMKN 1 Amuntai</title>
                    ...
                    <div class="flex items-center justify-between h-16 md:h-20">
                        ...
                        <div class="shrink-0 mr-4">
                            ...
                            <a class="block group" href="{{ route('home') }}" aria-label="Cruip">
                                <img src="{{ asset('images/logo-gambar.png') }}" alt="" class="h-12 hidden md:block">
                                <img src="{{ asset('images/logo_sekolah.png') }}" alt="" class="h-12 block md:hidden">
                            </a>
                        </div>
