...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Masuk Akun | Perpus SMKN 1 Amuntai</title>
    ...
    <body class="antialiased bg-white text-gray-900 font-[350]">
        ...
        <main class="flex">
                ...
                <div class="h-full">
                    ...
                    <div class="h-full w-full max-w-md px-6 mx-auto flex flex-col after:mt-auto after:flex-1">
                        ...
                        <div class="flex-1 py-8">
                            ...
                            <div class="mb-10">
                                <h1 class="h2 font-cabinet-grotesk">Selamat datang!</h1>
                            </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="flex items-center justify-between space-x-2 mt-6">
                                    <span class="text-gray-500 text-sm"><span class="hidden sm:inline">Belum menjadi anggota? </span><a class="font-medium text-blue-600 hover:underline" href="{{ route('register') }}">Daftar</a></span>
            ...
            <div class="fixed right-0 top-0 bottom-0 hidden lg:block lg:w-1/2 overflow-hidden" aria-hidden="true">
                ...
                <div class="absolute inset-0 bg-blue-600 pointer-events-none -z-10">
                    <img src="{{ asset('images/bg-login.jpg') }}" alt="">
                </div>
