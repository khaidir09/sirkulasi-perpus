        ...
        <div x-data="{ modalOpen: true }">
            ...
            >
                <div class="bg-white rounded shadow-lg overflow-auto max-w-xl w-full max-h-full">
                    ...
                    <!-- Modal content -->
                    <form action="{{ route('admin-konfirmasi-booking', $item->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('admin-booking.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
