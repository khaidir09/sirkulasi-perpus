<x-admin-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Page header -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Input Data Penerbit ✨</h1>
        </div>
        ...
        <div class="border-t border-slate-200">
            ...
            <div class="space-y-8 mt-8">
                ...
                <form action="{{ route('admin-penerbit.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <!-- Input Types -->
                    <div>
                        <div class="grid gap-5 md:grid-cols-2 mb-5">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input id="city" name="city" class="form-input w-full" type="text" required />
                                </div>
                                <!-- End -->
                            </div>
