<x-admin-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Page header -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Edit Data Klasifikasi ✨</h1>
        </div>
                        ...
                        <div class="grid gap-5 md:grid-cols-2 mb-5">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input id="kode" name="kode" class="form-input w-full" type="text" value="{{ $item->kode }}" />
                                </div>
                                <!-- End -->
                            </div>
