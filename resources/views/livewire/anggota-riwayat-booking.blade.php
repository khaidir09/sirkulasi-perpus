<div>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-3">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Riwayat Booking ✨</h1>
        </div>
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Search form -->
            <x-search-form placeholder="Judul buku" />                          
    ...
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">Semua Riwayat Booking <span class="text-slate-400 font-medium">{{ $bookings_count }}</span></h2>
    </header>
                                                ...
                                                <div class="p-5 flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <form action="{{ route('riwayat-booking.destroy', $booking->id) }}" method="post">
                                                                @method('delete')
                                                                @csrf
