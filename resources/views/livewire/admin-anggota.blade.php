<div>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-3">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Add customer button -->
            <a href="{{ route('admin-list-anggota.create') }}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1 flex">
                                    <a href="{{ route('admin-list-anggota.edit', $user->id) }}" class="text-slate-400 hover:text-slate-500 rounded-full">
                                                ...
                                                <div class="p-5 flex space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex flex-wrap justify-end space-x-2">
                                                            ...
                                                            <form action="{{ route('admin-list-anggota.destroy', $user->id) }}" method="post">
                                                                @method('delete')
                                                                @csrf
